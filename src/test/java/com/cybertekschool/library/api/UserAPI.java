...
public class UserAPI {
    ...
    public Response createUser(Map<String, Object> user, String userType) {
        // get a token
        ...
        Response response = given().
                ...
                log().all().
                when().
                post(Environment.getProperty("libraryurl") + ADD_USER).
                prettyPeek();
    ...
    /*public Response createUserResponse(Map<String, Object> user, String userType) {
        // get a token
        AuthenticationUtility authenticationUtility = new LibrarianAuthenticationUtility();
        String librarianToken = authenticationUtility.getToken();
        // create new user information
